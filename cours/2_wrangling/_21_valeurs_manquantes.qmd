...
::: {.info header="💡 Concept Clé : Le Mythe du Dataset Parfait"}
...
::: {.warning header="⚠️ Danger : Ignorer le MNAR"}
...
::: {.success header="🎒 Astuce Pro : Séries Temporelles"}
