...
ui.plotlyWrapper({
  ...
  data: [
    // Trace 1 : La courbe de précision
    {
      ...
      type: 'scatter',
      name: 'Précision',
      line: { color: ui.colors.blue || "#268bd2", width: ui.chart.lineWidth },
      marker: { 
        size: ui.chart.markerSize, 
        color: ui.colors.blue || "#268bd2",
        line: { color: ui.colors.base03 || "#002b36", width: ui.chart.markerLineWidth }
      }
    },
    ...
    intervention_month > 0 ? {
      ...
      line: { color: ui.colors.orange || "#cb4b16", width: ui.chart.markerLineWidth, dash: 'dot' },
      hoverinfo: 'none'
    } : {}
